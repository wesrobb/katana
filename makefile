...
RELEASE_FLAGS = -O2 -g
DEBUG_FLAGS = -O0 -g
DEFINES = -DGG_INTERNAL -DGAME_DLL=gg.so -DGAME_TEMP_DLL=gg_temp.so -DGG_EDITOR
DEFINES_D = -DGG_DEBUG -DGG_INTERNAL -DGAME_DLL=gg_d.so -DGAME_TEMP_DLL=gg_temp_d.so -DGG_EDITOR
